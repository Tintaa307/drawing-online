  ...
  return (
    <main className="w-full h-screen">
      <div className="w-full h-full flex items-center justify-center flex-col">
        <header className="flex flex-col gap-2 my-12">
          <h1 className="text-white/80 text-4xl font-normal">Welcome back!</h1>
          <p className="text-white/60 text-sm font-normal">
            Sign in to your account to continue using Drawing Online.
          </p>
        </header>
        ...
        >
          ...
          <input
            ...
            name="password"
          />
          <Button className="w-1/5 h-12 text-white mt-3">Sign in</Button>
        </form>
      </div>
    </main>
  )
